//This is rigid body contains coordinates [-45.583  0.000], [19.141 50.346], [46.9171  0.000], [-16.350 -43.005]

//body of DRF parameters
dx = 92.5; //total cross length
dx1 = 46.918; // +x direction (in blue)
dx2 = 45.582; //-x direction (in green)
dy = 99.87; //total cross length
dy1 = 53.8627; // +y direction (in red)
dy2 = 46.0073; //-y direction (in purple)
axy = 69.1825; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("APPLE 8",5, font = "Liberation Sans:style=Bold");}