//This is rigid body contains coordinates [-46.624 0.000], [6.236 58.035], [45.376 0.000], [-4.256 -39.610]


//body of DRF parameters
dx = 92; //total cross length
dx1 = 45.3739; // +x direction (in blue)
dx2 = 46.6261; //-x direction (in green)
dy = 98.21; //total cross length
dy1 = 58.3689; // +y direction (in red)
dy2 = 39.8411; //-y direction (in purple)
axy = 83.869; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("HONEYDEW 2",4.5, font = "Liberation Sans:style=Bold");}
