//This is rigid body contains coordinates [-44.685 0.000], [7.858 62.954], [44.815 0.000], [-4.393 -35.197]

//body of DRF parameters
dx = 89.5; //total cross length
dx1 = 44.8162; // +x direction (in blue)
dx2 = 44.6838; //-x direction (in green)
dy = 98.91; //total cross length
dy1 = 63.4427; // +y direction (in red)
dy2 = 35.4673; //-y direction (in purple)
axy = 82.8837; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("EGGFRUIT 3",4.5, font = "Liberation Sans:style=Bold");}
