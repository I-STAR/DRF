//This is rigid body contains coordinates [-49.161 0.000], [5.849 66.754], [50.839 0.000], [-2.255 -25.730]

//body of DRF parameters
dx = 100; //total cross length
dx1 = 50.8388; // +x direction (in blue)
dx2 = 49.1612; //-x direction (in green)
dy = 92.84; //total cross length
dy1 = 67.0101; // +y direction (in red)
dy2 = 25.8299; //-y direction (in purple)
axy = 84.9927; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("BANANA 3",5, font = "Liberation Sans:style=Bold");}
