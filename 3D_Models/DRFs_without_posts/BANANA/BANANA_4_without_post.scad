//This is rigid body contains coordinates [-49.267 0.000], [11.533 44.762], [50.733 0.000], [-9.107 -35.347]

//body of DRF parameters
dx = 100; //total cross length
dx1 = 50.73; // +x direction (in blue)
dx2 = 49.27; //-x direction (in green)
dy = 82.73; //total cross length
dy1 = 46.2228; // +y direction (in red)
dy2 = 36.5072; //-y direction (in purple)
axy = 75.5554; //angle between cross lengths
...
rotate([0,0,180])
linear_extrude(2)
{text("BANANA 4",5, font = "Liberation Sans:style=Bold");}
