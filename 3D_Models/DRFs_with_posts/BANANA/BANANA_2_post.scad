//This is rigid body contains coordinates [-47.364 0.000], [5.849 59.891], [44.636 0.000], [-5.891 -37.630]

//body of DRF parameters
dx = 92; //total cross length
dx1 = 44.6355; // +x direction (in blue)
dx2 = 47.3645; //-x direction (in green)
dy = 98.71; //total cross length
dy1 = 60.6202; // +y direction (in red)
dy2 = 38.0898; //-y direction (in purple)
axy = 81.1038; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("BANANA 2",5, font = "Liberation Sans:style=Bold");}
