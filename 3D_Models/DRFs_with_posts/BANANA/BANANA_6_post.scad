//This is rigid body contains coordinates [-53.637 0.000], [16.569 55.510], [46.363 0.000], [-6.648 -22.272]

//body of DRF parameters
dx = 100; //total cross length
dx1 = 46.3651; // +x direction (in blue)
dx2 = 53.6349; //-x direction (in green)
dy = 81.17; //total cross length
dy1 = 57.9305; // +y direction (in red)
dy2 = 23.2395; //-y direction (in purple)
axy = 73.378; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("BANANA 6",5, font = "Liberation Sans:style=Bold");}
