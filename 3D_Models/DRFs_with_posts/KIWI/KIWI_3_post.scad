//This is rigid body contains coordinates [-62.232 0.000], [-0.022 54.944], [29.768 0.000], [0.018 -44.466]


//body of DRF parameters
dx = 92; //total cross length
dx1 = 29.7678; // +x direction (in blue)
dx2 = 62.2322; //-x direction (in green)
dy = 99.41; //total cross length
dy1 = 54.944; // +y direction (in red)
dy2 = 44.466; //-y direction (in purple)
axy = 89.9769; //angle between cross lengths
...
rotate([0,0,180])
linear_extrude(2)
{text("KIWI 3",5, font = "Liberation Sans:style=Bold");}
