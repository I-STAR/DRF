//This is rigid body contains coordinates [-48.249 0.000], [10.239 60.293], [42.751 0.000], [-6.300 -37.098]

//body of DRF parameters
dx = 91; //total cross length
dx1 = 42.7543; // +x direction (in blue)
dx2 = 48.2457; //-x direction (in green)
dy = 98.78; //total cross length
dy1 = 61.1563; // +y direction (in red)
dy2 = 37.6237; //-y direction (in purple)
axy = 80.3592; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("KIWI 2",5, font = "Liberation Sans:style=Bold");}
