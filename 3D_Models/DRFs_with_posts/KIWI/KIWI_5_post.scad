//This is rigid body contains coordinates [-44.942 0.000], [0.420 59.097], [35.058 0.000], [-0.290 -40.823]


//body of DRF parameters
dx = 80; //total cross length
dx1 = 35.0597; // +x direction (in blue)
dx2 = 44.9403; //-x direction (in green)
dy = 99.92; //total cross length
dy1 = 59.0988; // +y direction (in red)
dy2 = 40.8212; //-y direction (in purple)
axy = 89.5907; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("KIWI 5",5, font = "Liberation Sans:style=Bold");}
