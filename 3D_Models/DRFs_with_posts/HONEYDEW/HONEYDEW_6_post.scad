//This is rigid body contains coordinates [-48.507 0.000], [13.733 51.053], [51.493 0.000], [-9.138 -33.972]


//body of DRF parameters
dx = 100; //total cross length
dx1 = 51.4916; // +x direction (in blue)
dx2 = 48.5084; //-x direction (in green)
dy = 88.05; //total cross length
dy1 = 52.8677; // +y direction (in red)
dy2 = 35.1823; //-y direction (in purple)
axy = 74.9457; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("HONEYDEW 6",4.5, font = "Liberation Sans:style=Bold");}
