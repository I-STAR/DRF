//This is rigid body contains coordinates [-50.753 0.000], [-0.213 60.067], [34.747 0.000], [0.138 -38.809]

//body of DRF parameters
dx = 85.5; //total cross length
dx1 = 34.7489; // +x direction (in blue)
dx2 = 50.7511; //-x direction (in green)
dy = 98.88; //total cross length
dy1 = 60.0671; // +y direction (in red)
dy2 = 38.8129; //-y direction (in purple)
axy = 89.7946; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("JUJUBE 5",5, font = "Liberation Sans:style=Bold");}
