//This is rigid body contains coordinates [-44.643 0.000], [9.278 55.667], [40.857 0.000], [-5.753 -34.519]

//body of DRF parameters
dx = 85.5; //total cross length
dx1 = 40.8561; // +x direction (in blue)
dx2 = 44.6439; //-x direction (in green)
dy = 91.43; //total cross length
dy1 = 56.4344; // +y direction (in red)
dy2 = 34.9956; //-y direction (in purple)
axy = 80.5383; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("JUJUBE 3",5, font = "Liberation Sans:style=Bold");}
