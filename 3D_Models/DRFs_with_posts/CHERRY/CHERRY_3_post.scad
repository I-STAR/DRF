//This is rigid body contains coordinates [-45.932 0.000], [4.892 51.000], [47.568 0.000], [-3.162 -32.965]

//body of DRF parameters
dx = 93.5; //total cross length
dx1 = 47.5683; // +x direction (in blue)
dx2 = 45.9317; //-x direction (in green)
dy = 84.35; //total cross length
dy1 = 51.2338; // +y direction (in red)
dy2 = 33.1162; //-y direction (in purple)
axy = 84.521; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("CHERRY 3",5, font = "Liberation Sans:style=Bold");}
