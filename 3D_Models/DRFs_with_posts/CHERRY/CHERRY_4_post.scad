//This is rigid body contains coordinates [-54.204 0.000], [1.046 55.765], [45.796 0.000], [-0.725 -38.678]


//body of DRF parameters
dx = 100; //total cross length
dx1 = 45.7957; // +x direction (in blue)
dx2 = 54.2043; //-x direction (in green)
dy = 94.46; //total cross length
dy1 = 55.7744; // +y direction (in red)
dy2 = 38.6856; //-y direction (in purple)
axy = 88.9257; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("CHERRY 4",5, font = "Liberation Sans:style=Bold");}
