//This is rigid body contains coordinates [-40.183 0.000], [4.781 51.676], [40.817 0.000], [-3.4010 -36.757].

//body of DRF parameters
dx = 81; //total cross length
dx1 = 40.8172; // +x direction (in blue)
dx2 = 40.1828; //-x direction (in green)
dy = 88.81; //total cross length
dy1 = 51.8971; // +y direction (in red)
dy2 = 36.9129; //-y direction (in purple)
axy = 84.7134; //angle between cross lengths
...
rotate([0,0,axy])
linear_extrude(2)
{text("APPLE 3",5, font = "Liberation Sans:style=Bold");}
